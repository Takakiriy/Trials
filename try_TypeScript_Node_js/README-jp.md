...
<!--
設定:
    __app__: __app2__  #original: __app__
    __command__: __app-command__
-->

`__app2__` は、____です。  #template: `__app__`
...
Windows の場合、__app2__.bat をダブルクリックして、下記のように入力します。 <!-- #template: __app__.bat  #-->
mac の場合、__app2__.command をダブルクリックして、下記のように入力します。 <!-- #template: __app__.command  #-->
