@echo off
rem ********************************************************************
rem * File: C.URL_Parameter/InstallAndRun.bat
rem *
rem * The base project is "B.Application".
rem ********************************************************************
...
:MainTry
	...
	start ""  "http://127.0.0.1:8000/%g_ApplicationName%"
	@echo off & if errorlevel 1 ( exit /b )
	pause
	@echo on

	start ""  "http://127.0.0.1:8000/%g_ApplicationName%/?msg=hello"
	@echo off & if errorlevel 1 ( exit /b )
	pause
	@echo on

	start ""  "http://127.0.0.1:8000/%g_ApplicationName%/123/taro"
	@echo off & if errorlevel 1 ( exit /b )
