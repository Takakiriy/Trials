...
export  g_ReactApplicationName="app-react"
#//==================================================================
...
function  CleanUp_func()
{
	...
	if [ "${application_name}" == "" ]; then
		application_name="${g_ReactApplicationName}"
	fi
	...
	rm -rf  "${application_name}/node_modules"
}
...
#********************************************************************
# Function: SetUpVariables_React_func
#********************************************************************
function  SetUpVariables_React_func()
{
	local  parent_of_this_sciprt="${g_ThisScriptPath%/*}"

	export g_ReactBinFolderPath="${parent_of_this_sciprt}/node_modules/.bin"
}


#********************************************************************
# Function: Install_React_func
#********************************************************************
function  Install_React_func()
{
...
echo "Skipped"  ;fi
	...
	if [ ! -e "${g_ReactBinFolderPath}" ]; then
		...
		echo  ""
		ColorEcho_func  "Install create-react-app ...\n"  "Green"
	...
	if [ ! -e "${application_name}" ]; then
		...
		echo  ""
		ColorEcho_func  "create-react-app  \"${application_name}\" ...\n"  "Green"
		EchoNextCommand_func
